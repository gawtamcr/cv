...
%  ----------------------------------------------------------------------------------
%  NOT an application resume. COPY THIS FILE to start every new single-* resume, then
%  fill the bracketed hints with tailored content. This file is the canonical seed and
%  Publications source — do NOT seed from single-ComVis.tex / single-GenMod.tex (they
%  are example outputs and may be deleted). See CLAUDE.md sec 3.
%
...
%   3. >= 30 content lines total (HARD floor). Education = 3 achv + Skills line;
...
\newcommand{\vSectionBefore}{-4pt} % space before each \section title
...
\newcommand{\vSubheadingEnd}{-10pt}% space after a resumeSubheading block
...
\newcommand{\vListEnd}{-7.5pt}     % space after resumeItemListEnd <- tighten THIS first if a real resume spills to page 2
...
% --- Summary (only used if an optional Summary section is added — rule 15; neutral defaults) ---
\newcommand{\vSummaryTop}{2pt}     % space atop the summary text
\newcommand{\vSummaryEnd}{-6pt}    % space after the summary text

% --- Education ---
\newcommand{\vEduSep}{0pt}         % space between education entries (0pt = adjacent, the seed default)
...
% --- Technical Projects ---
\newcommand{\vProjectEnd}{-18pt}   % space after a resumeProjectHeading block
