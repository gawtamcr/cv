...
%
% Values below are carried over from src/scripts/single-SeniorRoboticsResearcher.tex
% (tuned + visually verified with a Summary section present) — treat as this seed's
% defaults; re-tune per resume as needed.
...
\newcommand{\vListEnd}{-2pt}       % space after resumeItemListEnd <- tighten THIS first if a real resume spills to page 2
